											...
											<!--begin::Menu-->
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<div class="menu-content d-flex align-items-center px-3">
															...
															<div class="d-flex flex-column">
																<div class="fw-bolder d-flex align-items-center fs-5">Madona Insight
																<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">admin</span></div>
																<a href="#" class="fw-bold text-muted text-hover-primary fs-7">info@insightcbd.com</a>
															</div>
															<!--end::Username-->
														</div>
													</div>
													...
													<div class="menu-item px-5">
														<a href="apps/user-management/users/view.html" class="menu-link px-5">My Profile</a>
													</div>
													<!--end::Menu item-->
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">View Student Details</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">View Student</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
								...
								<div class="d-flex align-items-center py-1">
									...
									<!--end::Wrapper-->
									<!--begin::Button-->
									<a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button" style="background-color: red">Add Course</a>
									<!--end::Button-->
								</div>
								<!--end::Actions-->
							</div>
								...
								<div class="d-flex flex-column flex-xl-row">
											...
											<div class="card-body pt-0 pt-lg-1">
												...
												<div id="kt_user_view_details" class="collapse show">
													<div class="pb-5 fs-6">
														...
														<div class="text-gray-600">Emma Ahmed</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
														<div class="fw-bolder mt-5">Email</div>
														<div class="text-gray-600">
															<a href="#" class="text-gray-600 text-hover-primary">info@insightcbd.com</a>
														</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
														<div class="fw-bolder mt-5">Phone number</div>
														<div class="text-gray-600">+20 1288884313
														</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
														<div class="fw-bolder mt-5">Joined date</div>
														<div class="text-gray-600">20 Dec 2021, 11:05 am</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
									...
									<div class="flex-lg-row-fluid ms-lg-15">
										...
										<ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
											...
											<li class="nav-item">
												<a class="nav-link text-active-primary pb-4 active " data-bs-toggle="tab" href="#kt_user_view_overview_tab">Courses</a>
											</li>

											<li class="nav-item">
												<a class="nav-link text-active-primary pb-4 " data-bs-toggle="tab" href="#kt_user_view_overview_events_and_logs_tab">Payments</a>
											</li>
											<!--end:::Tab item-->
											<!--begin:::Tab item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_view_overview_security"> Change Password</a>
											</li>
											<!--end:::Tab item-->
											<!--begin:::Tab item-->
													...
													<div class="card-body py-0">
														...
														<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5" id="kt_table_customers_events">
															...
															<tbody>
																...
																<tr>
																	<!--begin::Event=-->
																	<td class="min-w-400px">IELTS
																	<span class="badge badge-light-danger">Active</span></td>
																	<!--end::Event=-->
																	<!--begin::Timestamp=-->
																	<td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2021, 10:10 pm</td>
																	<!--end::Timestamp=-->
																...
																<tr>
																	<!--begin::Event=-->
																	<td class="min-w-400px">PTE
																	<span class="badge badge-light-white" style="background-color: red;">Inactive</span></td>
																	<!--end::Event=-->
																	<!--begin::Timestamp=-->
																	<td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2021, 10:10 pm</td>
																	<!--end::Timestamp=-->
												...
												<div class="card card-flush mb-6 mb-xl-9">
													...
													<div class="card-header mt-6">
														...
														<div class="card-title flex-column">
															<h2 class="mb-1">Student's Schedule</h2>
															<div class="fs-6 fw-bold text-gray-400">2 upcoming sessions</div>
														</div>
														<!--end::Card title-->
														<!--begin::Card toolbar-->
														<div class="card-toolbar">
															...
															<div id="kt_schedule_day_1" class="tab-pane fade show active">
																...
																<div class="d-flex flex-stack position-relative mt-6">
																	...
																	<div class="fw-bold ms-5">
																		...
																		<!-- <a href="#" class="btn btn-sm btn-primary"  style="background-color: red" id="myBtn" data-bs-toggle="modal" data-bs-target="#mymodal">Cancel Course</a> -->

																		<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2" data-bs-toggle="modal" data-bs-target="#mymodal">IELTS course session 2</a>
																		<!--end::Title-->
															...
															<div class="modal" id="mymodal">
																...
																<div class="modal-dialog">
																	<div class="modal-content">
																		<div class="modal-header">
																			<h2 class="modal-title"> Session cancellation Request </h2>
	
																		</div>
																		<div class="modal-body">
	
																			<p> <strong>Please </strong>state the reason for session cancellation</p>
																			<textarea name="" id="" cols="30" rows="2" placeholder="Reason of cancelation"></textarea> <br> <br>
	
																			<p> Date & Time </p>
																			<p> Course Name </p>
																			<p> Session name </p>
																			<label for="javascript">Refund</label> 
																			<input type="text" placeholder="Amount"> 
																			<br> <br>
																			<textarea name="" id="" cols="30" rows="1" placeholder="Explanation" ></textarea> <br> <br>
	
																																		  
																			<button class="btn btn-sm btn-primary" style="background-color: red;">Submit Request</button>
																		</div>
																	</div>
																		...
																		<!--begin::User-->
																		<div class="fs-7 text-gray-400">Instrcutor 
																		<a href="#">Passant </a></div>
																		<!--end::User-->
																	</div>
																	<!--end::Info-->
																	<!--begin::Action-->
																...
																<div class="d-flex flex-stack position-relative mt-6">
																	...
																	<div class="fw-bold ms-5">
																		...
																		<!--end::Time-->
																		<!--begin::Title-->
																		<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">General English </a>
																		<!--end::Title-->
																		<!--begin::User-->
																		<div class="fs-7 text-gray-400">Instrcutor 
																		<a href="#">Habeeba</a></div>
																		<!--end::User-->
																	</div>
																	<!--end::Info-->
																	<!--begin::Action-->
																...
																<div class="d-flex flex-stack position-relative mt-6">
																	...
																	<div class="fw-bold ms-5">
																		...
																		<!--end::Time-->
																		<!--begin::Title-->
																		<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">PTE</a>
																		<!--end::Title-->
																		<!--begin::User-->
																		<div class="fs-7 text-gray-400">Instrcutor 
																		<a href="#">Merna</a></div>
										...
										<div class="modal-content">
											...
											<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
												...
												<form id="kt_modal_add_schedule_form" class="form" action="#">
													...
													<div class="fv-row mb-7">
														<!--begin::Label-->
														<label class="required fs-6 fw-bold form-label mb-2">Course Name</label>
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" class="form-control form-control-solid" name="event_name" value="" placeholder="IELTS" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="fv-row mb-7">
														<!--begin::Label-->
														<label class="required fs-6 fw-bold form-label mb-2">Session name</label>
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" class="form-control form-control-solid" name="event_org" value="" placeholder="Revision" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="fv-row mb-7">
														<!--begin::Label-->
														<label class="required fs-6 fw-bold form-label mb-2">Send course Details To</label>
														<!--end::Label-->
														<!--begin::Input-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://holmezz.com" target="_blank" class="text-gray-800 text-hover-primary">Holmezz</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								<li class="menu-item">
									<a href="https://keenthemes.com" target="_blank" class="menu-link px-2">Payment Policies</a>
								</li>
								...
								<div class="stepper-nav ps-lg-10">
									...
									<div class="stepper-item current" data-kt-stepper-element="nav">
										...
										<div class="stepper-label">
											<h3 class="stepper-title">Course Details</h3>
											<div class="stepper-desc">Enter your course Details</div>
										</div>
										<!--end::Label-->
									</div>
									<!--end::Step 1-->
									...
									<div class="stepper-item" data-kt-stepper-element="nav">
										...
										<div class="stepper-label">
											...
											<div class="stepper-desc">Define your payment method</div>
										</div>
										<!--begin::Label-->
									</div>
									<!--end::Step 2-->
									...
									<div class="stepper-item" data-kt-stepper-element="nav">
										...
										<!--begin::Label-->
										<div class="stepper-label">
											<h3 class="stepper-title">Payment Amount</h3>
											<div class="stepper-desc">Total paid amount</div>
										</div>
										<!--end::Label-->
									</div>
									<!--end::Step 3-->
									...
									<div class="stepper-item" data-kt-stepper-element="nav">
										...
										<div class="stepper-label">
											...
											<div class="stepper-desc">Review your course details</div>
										</div>
										<!--end::Label-->
									</div>
									<!--end::Step 4-->
										...
										<div class="w-100">
											...
											<div class="fv-row mb-10">
												...
												<label class="d-flex align-items-center fs-5 fw-bold mb-2">
													...
													<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify your course name"></i>
												</label>
												<!--end::Label-->
												<!--begin::Input-->
											...
											<div class="fv-row">
												...
												<label class="d-flex flex-stack cursor-pointer mb-5">
													...
													<span class="d-flex align-items-center me-2">
														...
														<span class="d-flex flex-column">
															<span class="fw-bolder fs-6">Previous test score</span>
															<input type="text" class="form-control form-control-lg form-control-solid" name="" placeholder="Previous test score	" value="" /> <br>


															<label class="required fw-bold fs-6 mb-2">Previous date</label>
												...
												<label class="required fw-bold fs-6 mb-2">Test upcoming date</label>
												<input type="date" class="form-control form-control-lg form-control-solid">
														</span>
														<!--end::Info-->
													</span>
											...
											<div class="fv-row">
												...
												<label class="d-flex align-items-center fs-5 fw-bold mb-4">
													<span class="required">Package Chosen</span>
												...
												<div class="fv-row">
													...
													<label class="d-flex flex-stack mb-5 cursor-pointer">
														...
														<span class="d-flex align-items-center me-2">
															...
															<!--begin:Info-->
															<span class="d-flex flex-column">
																<span class="fw-bolder fs-6">Private</span>
																<span class="fs-7 text-muted">Creating a Private course</span>
															</span>
															<!--end:Info-->
														</span>
														<!--end:Label-->
													...
													<label class="d-flex flex-stack mb-5 cursor-pointer">
														...
														<span class="d-flex align-items-center me-2">
															...
															<!--begin:Info-->
															<span class="d-flex flex-column">
																<span class="fw-bolder fs-6">Group</span>
																<span class="fs-7 text-muted">Creating a group course</span>
															</span>
															<!--end:Info-->
														</span>
														<!--end:Label-->
...
<label class="d-flex flex-stack mb-5 cursor-pointer">
	...
	<span class="d-flex align-items-center me-2">
		...
		<!--begin:Info-->
		<span class="d-flex flex-column">
			<span class="fw-bolder fs-6">Per hour</span>
			<span class="fs-7 text-muted">Creating a per hour session</span>
		</span>
		<!--end:Info-->
...
<select class="form-select" aria-label="Default select example">
	<option selected>Select number of sessions</option>
	...
	<option value="3">Six</option>
									...
									<div data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="fv-row">
												<!--begin::Label-->
												<label class="d-flex align-items-center fs-5 fw-bold mb-4">
													<span class="required">Select Payment</span>
												...
												<label class="d-flex flex-stack cursor-pointer mb-5">
													...
													<span class="d-flex align-items-center me-2">
														...
														<!--begin:Info-->
														<span class="d-flex flex-column">
															<span class="fw-bolder fs-6">Cash</span>
													...
													<span class="d-flex align-items-center me-2">
														...
														<span class="symbol symbol-50px me-6">
															<span class="symbol-label bg-light-success">
																<i class="far fa-credit-card text-success fs-2x"></i>
															</span>
														</span>
														<!--end:Icon-->
														<!--begin:Info-->
														<span class="d-flex flex-column">
															<span class="fw-bolder fs-6">Credit</span>
												...
												<label class="d-flex flex-stack cursor-pointer mb-5">
													...
													<span class="d-flex align-items-center me-2">
														...
														<span class="symbol symbol-50px me-6">
															<span class="symbol-label bg-light-danger">
																<i class="fas fa-university text-danger fs-2x"></i>
															</span>
														</span>
														<!--end:Icon-->
														<!--begin:Info-->
														<span class="d-flex flex-column">
															<span class="fw-bolder fs-6">Bank Transfer</span>
									...
									<div data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="fv-row mb-10">
												<!--begin::Label-->
												<label class="required fs-5 fw-bold mb-2">Total required amount</label>
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control form-control-lg form-control-solid" name="dbname" placeholder="" value="EGP" />
												<!--end::Input-->
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
											<div class="fv-row">
												<!--begin::Label-->
												<label class="d-flex align-items-center fs-5 fw-bold mb-4">
													<span class="required">Select payment method</span>
													...
													<span class="d-flex align-items-center me-2">
														...
														<span class="symbol symbol-50px me-6">
															<span class="symbol-label bg-light-success">
																...
																<label for=""> <strong >100</strong> &nbsp;</label>
																<i class="fas fa-percent text-success fs-1x"></i>
															</span>
														</span>
														<!--end::Icon-->
														<!--begin::Info-->
														<span class="d-flex flex-column">
															<span class="fw-bolder fs-6"> Full Payment</span>
															<span class="fs-7 text-muted"> 100% of total required amount</span>
												<input type="text" class="form-control form-control-lg form-control-solid" name="dbname" placeholder="" value="EGP" />
												<hr>
														</span>
														<!--end::Info-->
													...
													<span class="d-flex align-items-center me-2">
														...
														<span class="symbol symbol-50px me-6">
															<span class="symbol-label bg-light-danger">
																...
																<label for=""> <strong >50</strong> &nbsp;</label>
																<i class="fas fa-percent text-success fs-1x"></i>
														...
														<!--begin::Info-->
														<span class="d-flex flex-column">
															<span class="fw-bolder fs-6">Partial Payment</span>
															<span class="fs-7 text-muted">50% of total required amount</span>
												<input type="text" class="form-control form-control-lg form-control-solid" name="" placeholder="Paid amount" value="" />
												<span class="fw-bolder fs-6">&nbsp;</span>
												
												<input type="text" class="form-control form-control-lg form-control-solid" name="" placeholder="remaining amount" value="" /> <br>
												<span class="fw-bolder fs-6">&nbsp;</span>

												<label class="required fw-bold fs-6 mb-2">Date of second Payment</label>
												<input type="date" class="form-control form-control-lg form-control-solid">
														</span>
														<!--end::Info-->
													</span>
									...
									<div data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<!--end::Label-->
												<input type="text" class="form-control form-control-solid" placeholder="IELTS" name="card_name" value="" />
											...
											<div class="d-flex flex-column mb-7 fv-row">
												<!--begin::Label-->
												<label class="required fs-6 fw-bold form-label mb-2">Package Chosen</label>
												<!--end::Label-->
												<!--begin::Input wrapper-->
												<div class="position-relative">
													<!--begin::Input-->
													<input type="text" class="form-control form-control-solid" placeholder="EGP" name="" value="" />
													<!--end::Input-->
													<!--begin::Card logos-->
											...
											<div class="row mb-10">
												...
												<div class="col-md-8 fv-row">
													<!--begin::Label-->
													<label class="required fs-6 fw-bold form-label mb-2">Sign-up Date</label>

													<input type="date" class="form-control form-control-solid" placeholder="EGP" name="" value="" />
												...
												<div class="col-md-4 fv-row">
													...
													<label class="required fs-6 fw-bold form-label mb-2">Total required</label>
												<!--end::Label-->
												<!--begin::Input wrapper-->
												<div class="position-relative">
													<!--begin::Input-->
													...
													<label class="required fs-6 fw-bold form-label mb-2">Total paid</label>
												<!--end::Label-->
												<!--begin::Input wrapper-->
												<div class="position-relative">
													<!--begin::Input-->
												...
												<label class="required fs-6 fw-bold form-label mb-2">Total remaining</label>
												<!--end::Label-->
												<!--begin::Input wrapper-->
												<div class="position-relative">
													<!--begin::Input-->
											...
											<div class="col-md-8 fv-row">
												<!--begin::Label-->
												<label class="required fs-6 fw-bold form-label mb-2">Date of second Payment</label>
											...
											<div class="d-flex flex-stack">
												...
												<label class="form-check form-switch form-check-custom form-check-solid">
													<!-- <input class="form-check-input" type="checkbox" value="1" checked="checked" /> -->
													<span class="form-check-label fw-bold text-gray-400"> 1. Full refund will be given for cancellations made in excess of 5 working days before the
														course start date.
													<br>	2. For cancellations after the start of the course a 50% charge will apply to the remaining number of classes.
													<br>	3. No refund will be made to students who fail to attend classes or who do not complete the
														course.
														</span>
												</label>
												<!--end::Switch-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<!--end::Heading-->
											<!--begin::Description-->
											<div class="text-muted fw-bold fs-3">Submit your course to start adding schedule.</div>
											<!--end::Description-->
											<!--begin::Illustration-->
									...
									<div class="d-flex flex-stack pt-10">
										...
										<div>
											...
											<button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="submit">
												<span class="indicator-label"> Print
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Right-2.svg-->
												<span class="svg-icon svg-icon-3 ms-2 me-0">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		...
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/view.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/update-details.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/add-schedule.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/add-task.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/update-email.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/update-password.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/update-role.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/add-auth-app.js')}}"></script>
		<script src="{{URL::asset('assets/js/custom/apps/user-management/users/view/add-one-time-password.js')}}"></script>

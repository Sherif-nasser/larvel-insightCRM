							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<span class="menu-title">Instrcutors</span>
										<span class="menu-arrow"></span>
									</span>
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<a class="menu-link active py-3" href="apps/support-center/contact.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Contact Us</span>
										...
										<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
											...
											<ul class="nav flex-wrap border-transparent fw-bolder">
												...
												<li class="nav-item my-1">
													<a class="btn btn-color-gray-600 btn-active-white btn-active-color-primary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" href="apps/support-center/contact.html">Contact US</a>
												</li>
												<!--end::Nav item-->
											</ul>
											<!--end::Nav-->
											<!--begin::Action-->
											<a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_ticket" class="btn btn-success fw-bolder fs-8 fs-lg-base">Create Ticket</a>
											<!--end::Action-->
										</div>
										<!--end::Hero nav-->
									</div>
									...
									<div class="card-body p-lg-17">
										...
										<div class="row g-5 mb-5 mb-lg-15">
											...
											<div class="col-sm-6 pe-lg-10">
												...
												<div class="text-center bg-light card-rounded d-flex flex-column justify-content-center p-10 h-lg-100">
													...
													<!--end::Subtitle-->
													<!--begin::Number-->
													<div class="text-gray-700 fw-bold fs-2">+20 1206 10 1090</div>
													<!--end::Number-->
												</div>
												<!--end::Phone-->
											</div>
											...
											<div class="col-sm-6 ps-lg-10">
												...
												<div class="text-center bg-light card-rounded d-flex flex-column justify-content-center p-10 h-lg-100">
													...
													<!--end::Subtitle-->
													<!--begin::Description-->
													<div class="text-gray-700 fs-3 fw-bold">52, Gameat Eldawal El Arabia street, Mohandseen, Giza Egypt </div>
													<!--end::Description-->
												</div>
												<!--end::Address-->
											</div>
										...
										<div class="card mb-4 bg-light text-center">
											...
											<div class="card-body py-12">
												<!--begin::Icon-->
												<a href="https://web.facebook.com/INSIGHTCBD/?_rdc=1&_rdr" target="_blank" class="mx-4">
													<img src="assets/media/svg/brand-logos/facebook-4.svg" class="h-30px my-2" alt="" />
												</a>
												<!--end::Icon-->
												<!--begin::Icon-->
												<a href="https://www.instagram.com/insight_cbd/" class="mx-4" target="_blank">
												...
												<!-- linkedin -->
												<a href="https://www.linkedin.com/company/insight-canadian-business-development/" class="mx-4" target="_blank">
													<img src="assets/media/svg/brand-logos/instagram-2-1 - Copy.svg" class="h-30px my-2" alt="" />
												</a>
												<!--end::Icon-->
												<!--begin::Icon-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://holmezz.com.com" target="_blank" class="text-gray-800 text-hover-primary">Holmezz</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								<li class="menu-item">
									<a href="https://keenthemes.com" target="_blank" class="menu-link px-2">Money Poilcy</a>
								</li>
